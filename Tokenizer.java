...
public class Tokenizer
{
	...
	public Tokenizer(String str){
		...
		this.str = str;
                ...
                tokenDatas.add(new TokenData(Pattern.compile("^((-)?[0-9]+)"), TokenType.LITERAL_INT));
                tokenDatas.add(new TokenData(Pattern.compile("^(\".*\")"), TokenType.LITERAL_STRING));
                ...
                tokenDatas.add(new TokenData(Pattern.compile("^(_)"), TokenType.DATA_TYPE_CONNECTOR));
